...
{
    var name             = document.forms["new_client_form"]["name"].value;
    var address_line_one = document.forms["new_client_form"]["address_line_one"].value;
    var city             = document.forms["new_client_form"]["city"].value;
    var region           = document.forms["new_client_form"]["region"].value;
    var zip_postal       = document.forms["new_client_form"]["zip_postal"].value;
